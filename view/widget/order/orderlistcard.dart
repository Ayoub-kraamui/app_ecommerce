...
class CardOrdersList extends GetView<OrdersPandingController> {
  final OrdersModle ordersModle;
  const CardOrdersList({super.key, required this.ordersModle});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (ordersModle.ordersStatus == 0)
                  MaterialButton(
                    color: AppColor.thirColor,
                    textColor: Colors.white,
                    onPressed: () {
                      controller.deleteOrders(ordersModle.ordersId.toString());
                    },
                    child: const Text("Delete"),
                  ),
                if (ordersModle.ordersStatus == 3)
                  MaterialButton(
                    color: AppColor.thirColor,
                    textColor: Colors.white,
                    onPressed: () {
                      controller.goToPageTracking(ordersModle);
                    },
